...
package uk.gov.hmrc.eoricommoncomponent.frontend.controllers.nonProd
...
trait BackendBaseController
    extends play.api.mvc.BaseController with Utf8MimeTypes with WithJsonBody with BackendHeaderCarrierProvider
