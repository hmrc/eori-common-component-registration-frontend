...
class ContactDetailsForm() {
  ...
  def contactDetailsCreateForm(): Form[ContactDetailsViewModel] =
    Form(
      ...
      )(ContactDetailsViewModel.apply)(contactDetailsViewModel =>
        Some(contactDetailsViewModel.fullName, contactDetailsViewModel.emailAddress, contactDetailsViewModel.telephone)
      )
    )
