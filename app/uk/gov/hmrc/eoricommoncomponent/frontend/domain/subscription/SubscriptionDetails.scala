...
object SubscriptionDetails {
  ...
  private type FirstTwenty = OFormat[
    (
  ...
  private type LastTwo = OFormat[(Option[String], Option[String])]

  implicit val firstTwenty: FirstTwenty =
