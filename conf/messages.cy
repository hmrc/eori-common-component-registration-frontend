...
cds.subscription.address-details.street.error.invalid-chars=TRANSLATE Address cannot contain ''<'' or ''>''
cds.subscription.address-details.city.error.label = Nodwch eich tref neu ddinas
cds.subscription.address-details.city.error.invalid-chars=TRANSLATE Town or city cannot contain ''<'' or ''>''
...
cds.subscription.contact-details.form-error.full-name.wrong-format=TRNSLATE Enter your contact name without invalid characters
