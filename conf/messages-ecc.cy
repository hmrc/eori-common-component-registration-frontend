...
ecc.subscription.outcomes.success.xi.info.href=TRANSLATE Apply for an EORI number that starts with XI (opens in new tab).
...
ecc.eori-exists-group.cds.para1 = TRANSLATE If you want access to CDS, you need to ask the person who set up your Government Gateway user ID, or another person with administrator permissions in your Government Gateway team.
ecc.eori-exists-group.cds.para2 = TRANSLATE They will need to sign in and follow steps 6,7,8 and 9 to {0}.
ecc.eori-exists-group.cds.link = TRANSLATE give a team member access to a tax duty or scheme (opens in new tab)